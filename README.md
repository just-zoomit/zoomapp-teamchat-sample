...
'''
ngrok http 3000 --request-header-add "Strict-Transport-Security" --request-header-add "X-Content-Type-Options" --request-header-add “Referrer-Policy” 

ngrok http --domain=nominally-related-boa.ngrok-free.app 3000 --request-header-add "Strict-Transport-Security" --request-header-add "X-Content-Type-Options" --request-header-add “Referrer-Policy” 

ngrok http 3000 \
  --request-header-add="Strict-Transport-Security" \
  --request-header-add="X-Content-Type-Options" \
  --request-header-add="Content-Security-Policy" \
  --request-header-add=“Referrer-Policy” \
